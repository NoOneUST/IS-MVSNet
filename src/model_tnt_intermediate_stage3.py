...
class Module47(nn.Cell):
    def __init__(self, gather_0_weight_value, module7_0_reducesum_1_keep_dims, module7_0_reducesum_1_axis):
        ...
        self.reshape_1_shape = tuple([1, 8, 4, 8, 528, 960])
        self.reshape_2 = P.Reshape()
        self.reshape_2_shape = tuple([1, 8, 4, 8, 528, 960])
...
class MindSporeModel(nn.Cell):
    def __init__(self):
        ...
        self.add_318_bias = Parameter(Tensor(np.random.uniform(0, 1, (1, 1, 1, 528, 960)).astype(np.float32)),
                                      name=None)
        self.add_327_bias = Parameter(Tensor(np.random.uniform(0, 1, (1, 8, 8, 528, 960)).astype(np.float32)),
                                      name=None)
        ...
        self.module11_0 = Module11()
        self.sub_363_bias = Parameter(Tensor(np.random.uniform(0, 1, (1, 8, 1, 1)).astype(np.float32)), name=None)
